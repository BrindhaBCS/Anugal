...
@{ROLES_LIST}    &{ROLE_MAP_1}    &{ROLE_MAP_2}    &{ROLE_MAP_3}
...
One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_His_Roles
    ...
    ${One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_His_Roles_id}    Extract Order Number    ${multipleowner_multiplerole}
    Log    IGA-${One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_His_Roles_id}
    Set Global Variable    ${One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_His_Roles_id}
    Log To Console    **gbStart**One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_His_Roles**splitKeyValue**IGA-${One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_His_Roles_id}**gbEnd**
