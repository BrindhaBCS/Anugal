...
Approved multiple owner single role
    ...
    SeleniumLibrary.Input Text    id:search    ${angvar('Multipleowner_singlerole_id')}
    Sleep    2
    ...
    Log    ${status}
    Log To Console    **gbStart**Multipleowner_singlerole_status**splitKeyValue**${status}**gbEnd**
