...
Rejected single owner single role
    ...
    SeleniumLibrary.Input Text    id:search    ${angvar('Rejection_singleowner_singlerole_id')}
    Sleep    2
    ...
    Log    ${status}
    Log To Console    **gbStart**Reject_singleowner_singlerole_status**splitKeyValue**${status}**gbEnd**
