...
Rejections singleowner and singlerole
    ...
    ${Rejection_singleowner_singlerole_id}    Extract Order Number    ${Rejection_Access_req}
    Log    IGA-${Rejection_singleowner_singlerole_id}
    Set Global Variable    ${Rejection_singleowner_singlerole_id}
    Log To Console    **gbStart**Rejection_singleowner_singlerole**splitKeyValue**IGA-${Rejection_singleowner_singlerole_id}**gbEnd**
