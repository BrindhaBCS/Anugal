...
One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_Two_and_Rejects_One_Roles_roleB
    ...
    SeleniumLibrary.Input Text    id:search    117257    #${wvar('One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_His_Roles_id')}
    Sleep    2
    ...
    ${role1}    Get Text    xpath:(//img[@alt='ID Card']/following-sibling::p)[3]
    Log    ${role1}
    IF    '${role1}' == '${rolename1}'
    ...
    Scroll Element Into View    xpath:(//b[contains(text(),'Role Owners:')])[4]
    Sleep    2
    ${role2}    Get Text    xpath:(//img[@alt='ID Card']/following-sibling::p)[4]
    Log    ${role2}
    IF    '${role2}' == '${rolename2}'
        SeleniumLibrary.Click Element    xpath:(//input[@type='checkbox'])[3]
        Sleep    2
        SeleniumLibrary.Click Element    xpath://button[normalize-space(text())='Next']
        Sleep    2
    ELSE
