...
create_Access_Request
    ...
    Log    ${Access_req}
    ${Access_requiest_id}    Extract Order Number    ${Access_req}
    Log    IGA-${Access_requiest_id}
    Set Global Variable    ${Access_requiest_id}
    Log To Console    **gbStart**New_Access_request**splitKeyValue**IGA-${Access_requiest_id}**gbEnd**
