...
One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_Two_and_Rejects_One_Roles_roleA
    ...
    # Sleep    2
    Wait Until Element Is Visible    xpath://h2[normalize-space(text())='Harmony Developer']    20s
    SeleniumLibrary.Click Element    xpath:(//input[@type='checkbox'])[4]
    Scroll Element Into View    xpath:(//strong[contains(text(),'Valid From')])[3]
    Sleep    2
    Wait Until Element Is Visible    xpath://h2[normalize-space(text())='tag testing']    20s
    SeleniumLibrary.Click Element    xpath:(//input[@type='checkbox'])[8]
    Scroll Element Into View    xpath://img[@aria-label='Approve']
    Sleep    2
    ...
    Log    ${status}
    Log To Console    **gbStart**One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_Two_and_Rejects_One_Roles_status_roleA**splitKeyValue**${status}**gbEnd**
