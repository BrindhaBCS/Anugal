...
One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_Two_and_Rejects_One_Roles_roleA
    ...
    SeleniumLibrary.Input Text    id:search    117257    #${wvar('One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_Two_and_Rejects_One_Roles_id')}
    Sleep    2
    ...
    Sleep    4
    Wait Until Element Is Visible    xpath://span[normalize-space(text())='Select All']    30s
    Scroll Element Into View    xpath:(//b[contains(text(),'Role Owners:')])[4]
    Sleep    2

    ${role1}    Get Text    xpath:(//img[@alt='ID Card']/following-sibling::p)[4]
    Log    ${role1}
    IF    '${role1}' == 'asd'
