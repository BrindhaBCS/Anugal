...
Homepage Footer
    ...
    ${all_empty_report}=    Evaluate    all(not sublist for sublist in ${HomePage_report})
    Run Keyword If    ${all_empty_report}    Log To Console    **gbStart**HomePage_Result**splitKeyValue**${EMPTY_MESSAGE}**gbEnd**
