...
Rejection_of_One_Role_and_Approval_of_Others_roleB
    ...
    SeleniumLibrary.Input Text    id:search    117077    #${wvar('Rejection_of_One_Role_and_Approval_of_Others_id')}
    Sleep    2
    ...
    Sleep    2
    SeleniumLibrary.Input Text    xpath://textarea[@rows='7']    Rejected
    Sleep    1
