...
Rejection_of_One_Role_and_Approval_of_Others_roleB
    ...
    SeleniumLibrary.Input Text    id:search    ${angvar('Rejection_of_One_Role_and_Approval_of_Others_id')}
    Sleep    2
    ...
    Log    ${status}
    Log To Console    **gbStart**Rejection_of_One_Role_and_Approval_of_Others_status_roleB**splitKeyValue**${status}**gbEnd**
