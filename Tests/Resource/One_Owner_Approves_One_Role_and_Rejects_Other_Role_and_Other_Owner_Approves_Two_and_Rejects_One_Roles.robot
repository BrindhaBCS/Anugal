...
&{ROLE_MAP_2}    envm=QA Symphony    role=Harmony Auditor
&{ROLE_MAP_3}    envm=QA Symphony    role=BGM_ADMIN
&{ROLE_MAP_4}    envm=QA Symphony    role=Repo Configuration
&{ROLE_MAP_5}    envm=QA Symphony    role=test_agent
@{ROLES_LIST}    &{ROLE_MAP_1}    &{ROLE_MAP_2}    &{ROLE_MAP_3}    &{ROLE_MAP_4}    &{ROLE_MAP_5}
...
Start TestCase
    ...
    Sleep    2
    Wait Until Element Is Visible    xpath://span[text()='Mail']    20s
...
One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_Two_and_Rejects_One_Roles
    ...
    # Sleep    1
    # Scroll Element Into View    xpath:(//div[@id='mui-component-select-selectedDepartment'])[3]
    # Sleep    1
    # SeleniumLibrary.Click Element    xpath:(//div[@id='mui-component-select-selectedDepartment'])[2]
    # Sleep    1
    # SeleniumLibrary.Click Element    xpath://li[@data-value='Assign']
    # Sleep    1
    # Scroll Element Into View    xpath:(//div[@id='mui-component-select-selectedDepartment'])[4]
    # Sleep    1
    # SeleniumLibrary.Click Element    xpath:(//div[@id='mui-component-select-selectedDepartment'])[3]
    # Sleep    1
    # SeleniumLibrary.Click Element    xpath://li[@data-value='Assign']
    # Sleep    1
    # Scroll Element Into View    xpath:(//div[@id='mui-component-select-selectedDepartment'])[5]
    # Sleep    1
    # SeleniumLibrary.Click Element    xpath:(//div[@id='mui-component-select-selectedDepartment'])[4]
    # Sleep    1
    # SeleniumLibrary.Click Element    xpath://li[@data-value='Assign']
    # Sleep    1
    # # Scroll Element Into View    xpath:(//div[@id='mui-component-select-selectedDepartment'])[6]
    # Execute Javascript    window.scrollTo(0,500)
    # Sleep    1
    # SeleniumLibrary.Click Element    xpath:(//div[@id='mui-component-select-selectedDepartment'])[5]
    # Sleep    1
    # SeleniumLibrary.Click Element    xpath://li[@data-value='Assign']
    # Sleep    1
    ...
    FOR    ${index}    IN RANGE    1    5
        Scroll Element Into View    xpath:(//div[@id='mui-component-select-selectedDepartment'])[${index + 1}]
        Sleep    1
        SeleniumLibrary.Click Element    xpath:(//div[@id='mui-component-select-selectedDepartment'])[${index}]
        Sleep    1
        SeleniumLibrary.Click Element    xpath://li[@data-value='Assign']
        Sleep    1
    END

    # Final scroll and one last action
    Execute JavaScript    window.scrollTo(0,500)
    Sleep    1
    SeleniumLibrary.Click Element    xpath:(//div[@id='mui-component-select-selectedDepartment'])[5]
    Sleep    1
    ...
    ${One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_Two_and_Rejects_One_Roles_id}    Extract Order Number    ${multipleowner_multiplerole}
    Log    IGA-${One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_Two_and_Rejects_One_Roles_id}
    Set Global Variable    ${One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_Two_and_Rejects_One_Roles_id}
    Log To Console    **gbStart**One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_Two_and_Rejects_One_Roles**splitKeyValue**IGA-${One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_Two_and_Rejects_One_Roles_id}**gbEnd**
