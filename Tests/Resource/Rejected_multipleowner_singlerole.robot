...
Rejected multiple owner single role
    ...
    SeleniumLibrary.Input Text    id:search    ${angvar('Rejection_multipleowner_singlerole_id')}
    Sleep    2
    ...
    Sleep    2
    SeleniumLibrary.Input Text    xpath://textarea[@rows='7']    Reject the role
    Sleep    1
    ...
    Log    ${status}
    Log To Console    **gbStart**Reject_multipleeowner_singlerole_status**splitKeyValue**${status}**gbEnd**
