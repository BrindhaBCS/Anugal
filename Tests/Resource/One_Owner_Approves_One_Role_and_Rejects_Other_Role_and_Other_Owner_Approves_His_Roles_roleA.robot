...
One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_His_Roles_roleA
    ...
    SeleniumLibrary.Input Text    id:search    117174    #${wvar('One_Owner_Approves_One_Role_and_Rejects_Other_Role_and_Other_Owner_Approves_His_Roles_id')}
    Sleep    2
    ...
    ${role1}    Get Text    xpath:(//img[@alt='ID Card']/following-sibling::p)[2]
    Log    ${role1}
    IF    '${role1}' == 'asd'
