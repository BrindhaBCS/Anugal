...
&{ROLE_MAP_1}    envm=QA SYMPHONY    role=QA_QA
&{ROLE_MAP_2}    envm=Dev Symphony    role=testaudit
...
multiple role with multiple owner
    ...
    ${multipleowner_multiplerole_id}    Extract Order Number    ${multipleowner_multiplerole}
    Log    IGA-${multipleowner_multiplerole_id}
    Set Global Variable    ${multipleowner_multiplerole_id}
    Log To Console    **gbStart**multipleowner_multiplerole**splitKeyValue**IGA-${multipleowner_multiplerole_id}**gbEnd**
