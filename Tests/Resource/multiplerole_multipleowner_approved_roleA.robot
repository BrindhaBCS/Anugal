...
Approved multiple owner multiplerole role
    ...
    SeleniumLibrary.Input Text    id:search    ${angvar('multipleowner_multiplerole_id')}
    Sleep    2
    ...
    Log    ${status}
    Log To Console    **gbStart**multipleowner_multiplerole_status_A**splitKeyValue**${status}**gbEnd**
