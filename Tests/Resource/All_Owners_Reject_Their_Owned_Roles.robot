...
All Owners Reject Their Owned Roles
    ...
    ${All_owners_reject_their_owned_roles_id}    Extract Order Number    ${multipleowner_multiplerole}
    Log    IGA-${All_owners_reject_their_owned_roles_id}
    Set Global Variable    ${All_owners_reject_their_owned_roles_id}
    Log To Console    **gbStart**All_owners_reject_their_owned_roles**splitKeyValue**IGA-${All_owners_reject_their_owned_roles_id}**gbEnd**
