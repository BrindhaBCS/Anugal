...
multiple role with single role
    ...
    Log    ${Access_req}
    ${Multipleowner_singlerole_id}    Extract Order Number    ${Access_req}
    Log    IGA-${Multipleowner_singlerole_id}
    Set Global Variable    ${Multipleowner_singlerole_id}
    Log To Console    **gbStart**Multipleowner_singlerole**splitKeyValue**IGA-${Multipleowner_singlerole_id}**gbEnd**
